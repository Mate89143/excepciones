...
Primero se realizó una división entre números para controlar el error de división entre cero. Luego se capturaron excepciones específicas como "ValueError" y "ZeroDivisionError" al solicitar datos al usuario.
